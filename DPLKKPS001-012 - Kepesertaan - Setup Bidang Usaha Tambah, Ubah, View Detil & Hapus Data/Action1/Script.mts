...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-012 - Kepesertaan - Setup Bidang Usaha Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupBidangUsaha()
ElseIf iteration = 2 Then
	Call ViewSetupBidangUsaha()
ElseIf iteration = 3 Then
	Call EditSetupBidangUsaha()
ElseIf iteration = 4 Then
	Call DeleteSetupBidangUsaha()
End If
