...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-001 - Kepesertaan - Setup Pemasar Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupPemasar()
ElseIf iteration = 2 Then
	Call ViewSetupPemasar()
ElseIf iteration = 3 Then
	Call EditSetupPemasar()
ElseIf iteration = 4 Then
	Call DeleteSetupPemasar()
End If
