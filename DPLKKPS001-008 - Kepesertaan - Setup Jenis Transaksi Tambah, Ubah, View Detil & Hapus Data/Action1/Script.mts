...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-008 - Kepesertaan - Setup Jenis Transaksi Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisTransaksi()
ElseIf iteration = 2 Then
	Call ViewSetupJenisTransaksi()
ElseIf iteration = 3 Then
	Call EditSetupJenisTransaksi()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisTransaksi()
End If
