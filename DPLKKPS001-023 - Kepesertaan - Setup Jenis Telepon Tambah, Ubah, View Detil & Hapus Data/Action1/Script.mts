...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-023 - Kepesertaan - Setup Jenis Telepon Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisTelepon()
ElseIf iteration = 2 Then
	Call ViewSetupJenisTelepon()
ElseIf iteration = 3 Then
	Call EditSetupJenisTelepon()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisTelepon()
End If
