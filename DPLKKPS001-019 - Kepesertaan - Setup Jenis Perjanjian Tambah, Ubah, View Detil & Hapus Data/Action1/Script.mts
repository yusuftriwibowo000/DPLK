...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-019 - Kepesertaan - Setup Jenis Perjanjian Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisPerjanjian()
ElseIf iteration = 2 Then
	Call ViewSetupJenisPerjanjian()
ElseIf iteration = 3 Then
	Call EditSetupJenisPerjanjian()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisPerjanjian()
End If
