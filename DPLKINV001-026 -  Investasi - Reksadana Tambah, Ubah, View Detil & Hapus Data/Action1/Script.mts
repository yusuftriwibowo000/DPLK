...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-026 -  Investasi - Reksadana Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddProfileReksa()	
ElseIf iteration = 2 Then
	Call ViewProfileReksa()
ElseIf iteration = 3 Then
	Call EditProfileReksa()
ElseIf iteration = 4 Then
	Call DeleteProfileReksa()
End If
