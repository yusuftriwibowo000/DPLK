...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-018 - Setup Mapping PVR-TB Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupMappingPVRTB()
ElseIf iteration = 2 Then
	Call ViewSetupMappingPVRTB()
ElseIf iteration = 3 Then
	Call EditSetupMappingPVRTB()
ElseIf iteration = 4 Then
	Call DeleteSetupMappingPVRTB()
End If
