...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-018 - Kepesertaan - Setup Status NPWP Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupStatusNPWP()
ElseIf iteration = 2 Then
	Call ViewSetupStatusNPWP()
ElseIf iteration = 3 Then
	Call EditSetupStatusNPWP()
ElseIf iteration = 4 Then
	Call DeleteSetupStatusNPWP()
End If
