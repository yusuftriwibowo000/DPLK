...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-009 - Setup Sektor Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
ElseIf iteration = 2 Then
	Call ViewSetupSektor()
ElseIf iteration = 3 Then
	Call EditSetupSektor()
