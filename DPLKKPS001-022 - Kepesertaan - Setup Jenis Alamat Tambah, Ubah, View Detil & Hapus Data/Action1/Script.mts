...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-022 - Kepesertaan - Setup Jenis Alamat Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisAlamat()
ElseIf iteration = 2 Then
	Call ViewSetupJenisAlamat()
ElseIf iteration = 3 Then
	Call EditSetupJenisAlamat()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisAlamat()
End If
