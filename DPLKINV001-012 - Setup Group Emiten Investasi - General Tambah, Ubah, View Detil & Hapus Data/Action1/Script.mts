...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-012 - Setup Group Emiten Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupGroupEmiten()	
ElseIf iteration = 2 Then
	Call ViewSetupGroupEmiten()
ElseIf iteration = 3 Then
	Call EditSetupGroupEmiten()
