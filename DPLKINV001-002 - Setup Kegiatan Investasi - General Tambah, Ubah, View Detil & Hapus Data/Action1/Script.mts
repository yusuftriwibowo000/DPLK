...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-002 - Setup Kegiatan Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupKegiatan()	
ElseIf iteration = 2 Then
	Call ViewSetupKegiatan()
ElseIf iteration = 3 Then
	Call EditSetupKegiatan()
ElseIf iteration = 4 Then
	Call DeleteSetupKegiatan()
End If
