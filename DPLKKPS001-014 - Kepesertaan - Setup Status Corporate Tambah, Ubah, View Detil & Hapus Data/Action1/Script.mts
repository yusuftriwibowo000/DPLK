...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-014 - Kepesertaan - Setup Status Corporate Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupStatusCorporate()
ElseIf iteration = 2 Then
	Call ViewSetupStatusCorporate()
ElseIf iteration = 3 Then
	Call EditSetupStatusCorporate()
ElseIf iteration = 4 Then
	Call DeleteSetupStatusCorporate()
End If
