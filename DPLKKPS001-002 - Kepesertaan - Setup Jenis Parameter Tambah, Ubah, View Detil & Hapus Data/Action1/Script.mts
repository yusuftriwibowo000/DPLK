...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-002 - Kepesertaan - Setup Jenis Parameter Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisParameter()
ElseIf iteration = 2 Then
	Call ViewSetupJenisParameter()
ElseIf iteration = 3 Then
	Call EditSetupJenisParameter()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisParameter()
End If
