...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-013 - Setup Emiten Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
ElseIf iteration = 2 Then
	Call ViewSetupEmiten()
ElseIf iteration = 3 Then
	Call EditSetupEmiten()
ElseIf iteration = 4 Then
	Call DeleteSetupEmiten()
End If
