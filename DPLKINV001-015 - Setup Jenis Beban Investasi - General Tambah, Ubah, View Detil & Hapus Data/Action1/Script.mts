...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-015 - Setup Jenis Beban Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisBeban()	
ElseIf iteration = 2 Then
	Call ViewSetupJenisBeban()
ElseIf iteration = 3 Then
	Call EditSetupJenisBeban()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisBeban()
End If
