...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-010 - Setup Subsektor Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
ElseIf iteration = 2 Then
	Call ViewSetupSubSektor()
ElseIf iteration = 3 Then
	Call EditSetupSubSektor()
ElseIf iteration = 4 Then
	Call DeleteSetupSubSektor()
End If
