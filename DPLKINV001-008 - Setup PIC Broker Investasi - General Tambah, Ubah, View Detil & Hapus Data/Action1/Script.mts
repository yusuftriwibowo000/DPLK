...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-008 - Setup PIC Broker Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupPICBroker()	
ElseIf iteration = 2 Then
	Call ViewSetupPICBroker()
ElseIf iteration = 3 Then
	Call EditSetupPICBroker()
ElseIf iteration = 4 Then
	Call DeleteSetupPICBroker()
End If
