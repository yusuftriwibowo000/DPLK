...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-003 - Setup Klasifikasi Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupKlasifikasi()	
ElseIf iteration = 2 Then
	Call ViewSetupKlasifikasi()
ElseIf iteration = 3 Then
	Call EditSetupKlasifikasi()
