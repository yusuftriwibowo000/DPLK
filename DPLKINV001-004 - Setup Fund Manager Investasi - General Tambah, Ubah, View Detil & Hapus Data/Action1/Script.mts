...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-004 - Setup Fund Manager Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupFundManager()	
ElseIf iteration = 2 Then
	Call ViewSetupFundManager()
ElseIf iteration = 3 Then
	Call EditSetupFundManager()
ElseIf iteration = 4 Then
	Call DeleteSetupFundManager()
End If
