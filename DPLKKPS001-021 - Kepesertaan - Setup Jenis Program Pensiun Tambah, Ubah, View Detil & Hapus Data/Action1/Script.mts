...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-021 - Kepesertaan - Setup Jenis Program Pensiun Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisProgramPensiun()
ElseIf iteration = 2 Then
	Call ViewSetupJenisProgramPensiun()
ElseIf iteration = 3 Then
	Call EditSetupJenisProgramPensiun()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisProgramPensiun()
End If
