...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-014 - Setup Tipe Deviden Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupTipeDeviden()	
ElseIf iteration = 2 Then
	Call ViewSetupTipeDeviden()
ElseIf iteration = 3 Then
	Call EditSetupTipeDeviden()
ElseIf iteration = 4 Then
	Call DeleteSetupTipeDeviden()
End If
