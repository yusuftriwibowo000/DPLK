...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-016 - Kepesertaan - Setup Grup Parameter Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupGrupParameter()
ElseIf iteration = 2 Then
	Call ViewSetupGrupParameter()
ElseIf iteration = 3 Then
	Call EditSetupGrupParameter()
ElseIf iteration = 4 Then
	Call DeleteSetupGrupParameter()
End If
