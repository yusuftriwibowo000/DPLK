...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-011 - Kepesertaan - Setup Level Approval Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupLevelApproval()
ElseIf iteration = 2 Then
	Call ViewSetupLevelApproval()
ElseIf iteration = 3 Then
	Call EditSetupLevelApproval()
ElseIf iteration = 4 Then
	Call DeleteSetupLevelApproval()
End If
