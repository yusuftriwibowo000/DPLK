...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-003 - Kepesertaan - Setup Jenis Manfaat Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisManfaat()
ElseIf iteration = 2 Then
	Call ViewSetupJenisManfaat()
ElseIf iteration = 3 Then
	Call EditSetupJenisManfaat()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisManfaat()
End If
