...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-013 - Kepesertaan - Setup Status Peserta Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupStatusPeserta()
ElseIf iteration = 2 Then
	Call ViewSetupStatusPeserta()
ElseIf iteration = 3 Then
	Call EditSetupStatusPeserta()
ElseIf iteration = 4 Then
	Call DeleteSetupStatusPeserta()
End If
