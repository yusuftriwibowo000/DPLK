...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-016 - Setup Parameter Investasi Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupParameterInvestasi()
ElseIf iteration = 2 Then
	Call ViewSetupParameterInvestasi()
ElseIf iteration = 3 Then
	Call EditSetupParameterInvestasi()
ElseIf iteration = 4 Then
	Call DeleteSetupParameterInvestasi()
End If
