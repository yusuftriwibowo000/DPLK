...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-004 - Kepesertaan - Setup Jenis Biaya Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisBiaya()
ElseIf iteration = 2 Then
	Call ViewSetupJenisBiaya()
ElseIf iteration = 3 Then
	Call EditSetupJenisBiaya()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisBiaya()
End If
