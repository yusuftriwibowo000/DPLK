...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-022 -  Investasi - Fixed Income Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddTipeTransaksi()	
ElseIf iteration = 2 Then
	Call ViewTipeTransaksi()
ElseIf iteration = 3 Then
	Call EditTipeTransaksi()
ElseIf iteration = 4 Then
	Call DeleteTipeTransaksi()
End If
