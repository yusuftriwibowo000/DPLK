...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-005 - Setup Custodian Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupCustodian()	
ElseIf iteration = 2 Then
	Call ViewSetupCustodian()
ElseIf iteration = 3 Then
	Call EditSetupCustodian()
