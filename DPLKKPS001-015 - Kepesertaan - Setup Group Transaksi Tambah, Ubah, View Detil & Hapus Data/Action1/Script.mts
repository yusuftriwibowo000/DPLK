...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-015 - Kepesertaan - Setup Group Transaksi Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupGroupTransaksi()
ElseIf iteration = 2 Then
	Call ViewSetupGroupTransaksi()
ElseIf iteration = 3 Then
	Call EditSetupGroupTransaksi()
ElseIf iteration = 4 Then
	Call DeleteSetupGroupTransaksi()
End If
