...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-011 - Setup Jenis Emiten Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisEmiten()	
ElseIf iteration = 2 Then
	Call ViewSetupJenisEmiten()
ElseIf iteration = 3 Then
	Call EditSetupJenisEmiten()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisEmiten()
End If
