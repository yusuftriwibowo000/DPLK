...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKEU001-001 - Setup Mapping Bank Pembayaran - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKEU001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupMappingBankPembayaran()
ElseIf iteration = 2 Then
	Call ViewSetupMappingBankPembayaran()
ElseIf iteration = 3 Then
	Call EditSetupMappingBankPembayaran()
ElseIf iteration = 4 Then
	Call DeleteSetupMappingBankPembayaran()
End If
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathDPLK & "DPLK_Keuangan_Setup.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_Login.tsr")
	Call RepositoriesCollection.Add(LibRepo & "RP_Administration_Dashboard.tsr")
	Call RepositoriesCollection.Add(LibRepo & "RP_Keuangan_Setup.tsr")
