...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-023 -  Investasi - Fixed Income Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddProfileFixedIncome()	
ElseIf iteration = 2 Then
	Call ViewProfileFixedIncome()
ElseIf iteration = 3 Then
	Call EditProfileFixedIncome()
ElseIf iteration = 4 Then
	Call DeleteProfileFixedIncome()
End If
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathDPLK & "DPLK_Investasi_Fixed_Income.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_Login.tsr")
	Call RepositoriesCollection.Add(LibRepo & "RP_Administration_Dashboard.tsr")
	Call RepositoriesCollection.Add(LibRepo & "RP_Investasi_Fixed_Income.tsr")
