...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS001-009 - Kepesertaan - Setup Jenis Approval Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKPS001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisApproval()
ElseIf iteration = 2 Then
	Call ViewSetupJenisApproval()
ElseIf iteration = 3 Then
	Call EditSetupJenisApproval()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisApproval()
End If
