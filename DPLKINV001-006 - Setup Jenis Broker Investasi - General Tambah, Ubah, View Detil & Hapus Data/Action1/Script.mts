...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV001-006 - Setup Jenis Broker Investasi - General Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKINV001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupJenisBroker()	
ElseIf iteration = 2 Then
	Call ViewSetupJenisBroker()
ElseIf iteration = 3 Then
	Call EditSetupJenisBroker()
ElseIf iteration = 4 Then
	Call DeleteSetupJenisBroker()
End If
